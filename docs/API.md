...
| POST   | `/events/:id/cancel`      | 🔑    | —                                                 | `200 { ok: true }` (**creator only**; `eventCancelUser`; 403 non-creator, 404 missing/deleted, 409 already cancelled) |
